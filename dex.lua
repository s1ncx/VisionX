	...
	The main explorer interface
		...
		local function main()
			...
			Explorer.InitRightClick = function()
				...
				context:Register("PASTE",{Name = "Paste", IconMap = Explorer.MiscIcons, Icon = "Paste", DisabledIcon = "Paste_Disabled", Shortcut = "Ctrl+Shift+V", OnClick = function()
					local sList = selection.List
					local newSelection = {}
					local count = 1
					for i = 1,#sList do
				...
				context:Register("SELECT_CHILDREN",{Name = "Select Everything Inside", IconMap = Explorer.MiscIcons, Icon = "SelectChildren", DisabledIcon = "SelectChildren_Disabled", OnClick = function()
					local newSelection = {}
					local count = 1
					local sList = selection.List
				...
				context:Register("VIEW_PLAYER",{Name = "Spieler beobachten", IconMap = Explorer.ClassIcons, Icon = 5, OnClick = function()
					local newSelection = {}
					local count = 1
					local sList = selection.List
					local isa = game.IsA
	...
	A script viewer that is basically a notepad
		...
		local function main()
			...
			ScriptViewer.Init = function()
				...
				local dumpGameBtn = Instance.new("TextButton",window.GuiElems.Content)
				dumpGameBtn.BackgroundTransparency = 1
				dumpGameBtn.Position = UDim2.new(0.75,0,0,0)
				dumpGameBtn.Size = UDim2.new(0.25,0,0,20)
				dumpGameBtn.Text = "Dump Full Source"
				dumpGameBtn.TextColor3 = Color3.new(1,1,1)
				dumpGameBtn.MouseButton1Click:Connect(function()
					Main.DumpFullSource()
				end)
		...
		local function main()
			...
			Lib.Window = (function()
				...
				local createGui = function(self)
					local gui = create({
						{1,"ScreenGui",{DisplayOrder=Main.DisplayOrders.Window,IgnoreGuiInset=true,ZIndexBehavior=1,Name="Window",}},
						...
						{3,"Frame",{BackgroundColor3=Color3.fromRGB(12,12,14),BorderSizePixel=0,Name="Content",Parent={2},Position=UDim2.new(0,0,0,22),Size=UDim2.new(1,0,1,-22),ClipsDescendants=true}},
						{4,"Frame",{BackgroundColor3=Color3.fromRGB(24,24,30),BorderSizePixel=0,Name="Line",Parent={3},Size=UDim2.new(1,0,0,1),}},
						{5,"TextButton",{Text="",AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(16,16,20),BorderSizePixel=0,Name="TopBar",Parent={2},Size=UDim2.new(1,0,0,22),}},
						{6,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={5},Position=UDim2.new(0,10,0,0),Size=UDim2.new(1,-20,0,22),Text="Window",TextColor3=Color3.fromRGB(235,235,240),TextSize=14,TextXAlignment=0,}},
						...
						{13,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,BorderSizePixel=0,Image="",Name="Outlines",Parent={2},Visible=false}},
						{14,"UICorner",{CornerRadius=UDim.new(0,0),Parent={5}}},
						{15,"UIStroke",{Color=Color3.fromRGB(42,42,48),Thickness=1,Transparency=0.2,ApplyStrokeMode=Enum.ApplyStrokeMode.Border,Parent={2}}},
						{16,"Frame",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Name="ResizeControls",Parent={2},Position=UDim2.new(0,-5,0,-5),Size=UDim2.new(1,10,1,10),}},
						{17,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="North",Parent={16},Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="South",Parent={16},Position=UDim2.new(0,5,1,-5),Size=UDim2.new(1,-10,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{19,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="NorthEast",Parent={16},Position=UDim2.new(1,-5,0,0),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{20,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="East",Parent={16},Position=UDim2.new(1,-5,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{21,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="West",Parent={16},Position=UDim2.new(0,0,0,5),Size=UDim2.new(0,5,1,-10),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{22,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="SouthEast",Parent={16},Position=UDim2.new(1,-5,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{23,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="NorthWest",Parent={16},Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
						{24,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.27450981736183,0.27450981736183,0.27450981736183),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="SouthWest",Parent={16},Position=UDim2.new(0,0,1,-5),Size=UDim2.new(0,5,0,5),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
					})
			...
			rightSide.Frame:TweenPosition(rightTweenPos,Enum.EasingDirection.Out,Enum.EasingStyle.Quad,0.3,true)]]
				...
				static.Init = function()
					...
					sidesGui.DisplayOrder = Main.DisplayOrders.SideWindow
					sidesGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
Main = (function()
	...
	Main.DumpFullSource = function()
		...
		local function ensureFolder(path)
			if env.isfolder and env.isfolder(path) then return true end
			local ok = pcall(env.makefolder, path)
			return ok
		end

		local placeFolder = sanitizeName(tostring(game.PlaceId) .. " " .. game.Name)
		local rootFolder = "dex/saved/" .. placeFolder
		ensureFolder("dex")
		ensureFolder("dex/saved")
		...
		for i = 1, #scripts do
			...
			if obj:IsA("ModuleScript") then
				local fullName = obj:GetFullName():gsub("^game%.", "")
				local parts = string.split(fullName, ".")
				local fileName = sanitizeName(parts[#parts]) .. ".lua"
				local folderPath = rootFolder
				for pIndex = 1, #parts - 1 do
					folderPath = folderPath .. "/" .. sanitizeName(parts[pIndex])
					ensureFolder(folderPath)
				end

				local sourceText = "-- Failed to dump source for: " .. obj:GetFullName()
				if env.decompile then
					local ok, src = pcall(env.decompile, obj)
					if ok and src and #src > 0 then
						sourceText = src
					end
				end

				pcall(env.writefile, folderPath .. "/" .. fileName, sourceText)
			end
		end
	end
	...
	Main.CreateMainGui = function()
		local gui = create({
			{1,"ScreenGui",{DisplayOrder=Main.DisplayOrders.Core+20,IgnoreGuiInset=true,ZIndexBehavior=1,Name="MainMenu",}},
		...
		local propertiesAppControl = Main.CreateApp({Name = "Properties", IconMap = Main.LargeIcons, Icon = "Properties", Window = Properties.Window})

		local scriptViewerAppControl = Main.CreateApp({Name = "Script Viewer", IconMap = Main.LargeIcons, Icon = "Script_Viewer", Open = true, Window = ScriptViewer.Window})

		Main.ScriptViewerAppControl = scriptViewerAppControl
		Main.PropertiesAppControl = propertiesAppControl

		local settingsButton = gui.OpenButton.MainFrame.BottomFrame.Settings
		settingsButton.MouseButton1Click:Connect(function()
			if Properties.Window:IsVisible() then
				if Main.PropertiesAppControl then
					Main.PropertiesAppControl.Disable()
				else
					Properties.Window:Hide()
				end
			else
				if Main.PropertiesAppControl then
					Main.PropertiesAppControl.Enable()
				else
					Properties.Window:Show({Silent = true})
				end
			...
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end)

		local topGui = create({
			{1,"ScreenGui",{DisplayOrder=Main.DisplayOrders.Core+40,IgnoreGuiInset=true,ZIndexBehavior=1,Name="DashboardTop",}},
			{2,"Frame",{BackgroundColor3=Color3.fromRGB(9,11,17),BackgroundTransparency=0.12,BorderSizePixel=0,Name="TopBar",Parent={1},Position=UDim2.new(0,8,0,8),Size=UDim2.new(1,-16,0,64),}},
			{3,"UIListLayout",{FillDirection=Enum.FillDirection.Horizontal,Padding=UDim.new(0,6),Parent={2},SortOrder=Enum.SortOrder.LayoutOrder,VerticalAlignment=Enum.VerticalAlignment.Center}},
			{4,"UIPadding",{PaddingLeft=UDim.new(0,12),PaddingRight=UDim.new(0,12),Parent={2}}},
			{5,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.fromRGB(33,37,48),BorderSizePixel=0,Font=3,Name="ToggleTopBar",Parent={1},Position=UDim2.new(0,8,0,8),Size=UDim2.new(0,44,0,44),Text="≡",TextColor3=Color3.new(1,1,1),TextSize=24}},
			
		})

		local function makeTopButton(name,text,color,order,size)
			local b = Instance.new("TextButton")
			b.Name = name
			b.LayoutOrder = order
			b.AutoButtonColor = false
			...
			b.BorderSizePixel = 0
			b.Size = size or UDim2.new(0,110,0,38)
			b.Font = Enum.Font.SourceSansBold
			b.Text = text
			b.TextColor3 = Color3.new(1,1,1)
			b.TextSize = 17
			b.Parent = topGui.TopBar
			return b
		end
		...
		title.Text = "BeeKeeper - Dex"
		title.TextColor3 = Color3.new(1,1,1)
		title.TextSize = 22
		title.TextXAlignment = Enum.TextXAlignment.Left
		title.Parent = topGui.TopBar

		local btnExplore = makeTopButton("ExploreBtn","Explore",Color3.fromRGB(39,44,56),2,UDim2.new(0,120,0,38))
		local btnScript = makeTopButton("ScriptBtn","Script View",Color3.fromRGB(39,44,56),3,UDim2.new(0,140,0,38))
		local btnProt = makeTopButton("ProtBtn","Prot",Color3.fromRGB(39,44,56),4,UDim2.new(0,95,0,38))
		local btnSelect = makeTopButton("SelectBtn","Select",Color3.fromRGB(55,75,125),5,UDim2.new(0,95,0,38))
		local btnClose = makeTopButton("CloseBtn","Close",Color3.fromRGB(127,42,53),6,UDim2.new(0,90,0,38))
		local btnDump = makeTopButton("DumpBtn","Dump",Color3.fromRGB(42,94,67),7,UDim2.new(0,90,0,38))

		Main.TopBarGui = topGui
		Main.TopBarVisible = true
		Lib.ShowGui(topGui)

		local function updateSelectButtonState()
			local enabled = (Main.ClickSelectEnabled == true)
			btnSelect.Text = enabled and "Selecting" or "Select"
			btnSelect.BackgroundColor3 = enabled and Color3.fromRGB(36,122,88) or Color3.fromRGB(55,75,125)
		end

		local function updateTopBarSizing()
			local viewport = workspace.CurrentCamera and workspace.CurrentCamera.ViewportSize or Vector2.new(1280, 720)
			local maxW = viewport.X - 16
			topGui.TopBar.Size = UDim2.new(0, maxW, 0, 64)

			local buttons = {btnExplore, btnScript, btnProt, btnSelect, btnClose, btnDump}
			local minWidths = {88, 104, 72, 72, 68, 68}
			local baseWidths = {120, 140, 95, 95, 90, 90}
			local titleW = 170
			local spacing = 6
			local sidePadding = 24
			local totalBase = titleW + sidePadding + spacing * #buttons
			for i = 1,#baseWidths do totalBase = totalBase + baseWidths[i] end
			local scale = math.min(1, maxW / totalBase)

			title.Size = UDim2.new(0, math.max(120, math.floor(titleW * scale)), 1, 0)
			for i = 1,#buttons do
				local w = math.max(minWidths[i], math.floor(baseWidths[i] * scale))
				buttons[i].Size = UDim2.new(0, w, 0, 38)
				buttons[i].TextSize = (scale < 0.9) and 16 or 17
			end
		end

		local function toggleTopBar()
			Main.TopBarVisible = not Main.TopBarVisible
			topGui.TopBar.Visible = Main.TopBarVisible
			topGui.ToggleTopBar.Text = Main.TopBarVisible and "≡" or "▲"
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end
		...
		do
			...
			topGui.ToggleTopBar.InputBegan:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					dragging = true
					moved = false
					dragStart = input.Position
					startPos = topGui.ToggleTopBar.Position
				end
			end)
			topGui.ToggleTopBar.InputChanged:Connect(function(input)
				...
				if input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch then
					...
					if moved then
						local viewport = workspace.CurrentCamera and workspace.CurrentCamera.ViewportSize or Vector2.new(1280, 720)
						local newX = math.clamp(startPos.X.Offset + delta.X, 0, viewport.X - topGui.ToggleTopBar.AbsoluteSize.X)
						local newY = math.clamp(startPos.Y.Offset + delta.Y, 0, viewport.Y - topGui.ToggleTopBar.AbsoluteSize.Y)
						topGui.ToggleTopBar.Position = UDim2.new(0,newX,0,newY)
					end
				end
			end)
			topGui.ToggleTopBar.InputEnded:Connect(function(input)
				if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
					local wasMoved = moved
					dragging = false
					moved = false
					if not wasMoved then toggleTopBar() end
				end
			end)
		end

		Main.UpdateTopBarSizing = updateTopBarSizing
		updateTopBarSizing()

		local function setWindowVisible(window, control, visible, immediate)
			if visible then
				window:Show({Silent = true})
				if control and control.Enable then control.Enable(true) end
				if window == Properties.Window then
					Lib.DeferFunc(function()
						Properties.UpdateView()
						Properties.Update()
						Properties.Refresh()
				...
				if immediate then window.Aligned = true end
				window:Hide()
				if control and control.Disable then control.Disable(true) end
			end
		end

		btnExplore.MouseButton1Click:Connect(function()
			setWindowVisible(Explorer.Window, Main.MenuApps.Explorer, not Explorer.Window:IsVisible())
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end)

		btnScript.MouseButton1Click:Connect(function()
			setWindowVisible(ScriptViewer.Window, Main.ScriptViewerAppControl, not ScriptViewer.Window:IsVisible())
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end)

		btnProt.MouseButton1Click:Connect(function()
			setWindowVisible(Properties.Window, Main.PropertiesAppControl, not Properties.Window:IsVisible())
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end)

		btnClose.MouseButton1Click:Connect(function()
			setWindowVisible(Explorer.Window, Main.MenuApps.Explorer, false, true)
			setWindowVisible(ScriptViewer.Window, Main.ScriptViewerAppControl, false, true)
			setWindowVisible(Properties.Window, Main.PropertiesAppControl, false, true)
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
		end)
		...
		btnSelect.MouseButton1Click:Connect(function()
			if Main.MenuApps["Click to Select Part"] then
				if Main.ClickSelectEnabled then
					Main.MenuApps["Click to Select Part"].Disable()
				else
					Main.MenuApps["Click to Select Part"].Enable()
				end
			end
		end)

		Main.UpdateSelectModelButton = updateSelectButtonState
		updateSelectButtonState()

		local cptsOnMouseClick = nil
		Main.CreateApp({Name = "Click to Select Part", IconMap = Main.LargeIcons, Icon = 6, OnClick = function(callback)
			Main.ClickSelectEnabled = callback and true or false
			if Main.UpdateSelectModelButton then Main.UpdateSelectModelButton() end
			if callback then
				local mouse = Main.Mouse
	...
	Main.Init = function()
		...
		-- Init window system, create main menu, and apply fullscreen dashboard layout
		Lib.Window.Init()
		Main.CreateMainGui()

		Explorer.Window:Show({Silent = true})
		ScriptViewer.Window:Show({Silent = true})
		Properties.Window:Hide()

		Main.ApplyDashboardLayout = function()
			local viewport = workspace.CurrentCamera and workspace.CurrentCamera.ViewportSize or Vector2.new(1280, 720)
			local width, height = viewport.X, viewport.Y
			local gap = 10
			local padding = 10
			local top = (Main.TopBarVisible == false and 10 or 84)
			local panelHeight = math.max(300, height - top - padding)
			local visExplorer = Explorer.Window:IsVisible()
			local visScript = ScriptViewer.Window:IsVisible()
			local visProperties = Properties.Window:IsVisible()

			Lib.Window.SetSideVisible("left", false)
			Lib.Window.SetSideVisible("right", false)

			local function lockWindow(window)
				window:SetAligned(false)
				window.Draggable = false
				window.Alignable = false
				window:SetResizable(false)
			end

			local function placeWindow(window, x, w)
				lockWindow(window)
				window:Resize(w, panelHeight)
				window.GuiElems.Main.Position = UDim2.new(0, x, 0, top)
				window.PosX = x
				window.PosY = top
			end

			local visible = {}
			if visExplorer then visible[#visible+1] = Explorer.Window end
			if visScript then visible[#visible+1] = ScriptViewer.Window end
			if visProperties then visible[#visible+1] = Properties.Window end
			if #visible == 0 then return end

			local widths
			if #visible == 1 then
				widths = {width - padding * 2}
			elseif #visible == 2 then
				if visExplorer and visScript then
					local leftW = math.floor(width * 0.24)
					widths = {leftW, width - (padding * 2) - gap - leftW}
				else
					local each = math.floor((width - padding * 2 - gap) / 2)
					widths = {each, width - (padding * 2) - gap - each}
				end
			else
				local leftW = math.floor(width * 0.2)
				local propW = math.floor(width * 0.26)
				widths = {leftW, width - (padding * 2) - (gap * 2) - leftW - propW, propW}
			end

			local currentX = padding
			for i = 1,#visible do
				placeWindow(visible[i], currentX, widths[i])
				currentX = currentX + widths[i] + (i < #visible and gap or 0)
			end
		end

		Explorer.Window.OnActivate:Connect(function() if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end end)
		ScriptViewer.Window.OnActivate:Connect(function() if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end end)
		Properties.Window.OnActivate:Connect(function() if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end end)
		Properties.Window.OnDeactivate:Connect(function() if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end end)

		Lib.DeferFunc(function()
			if Main.ApplyDashboardLayout then Main.ApplyDashboardLayout() end
			if Main.UpdateTopBarSizing then Main.UpdateTopBarSizing() end
